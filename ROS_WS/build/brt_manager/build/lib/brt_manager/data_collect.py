...
class TimeSynchronize(Node):
    ...
    def __init__(self):
        ...
        self.get_logger().info("Data Collect Run...")
        self.get_logger().info("Time Synchronize Run ...")
        ...
        self.ts = ApproximateTimeSynchronizer(
            ...
            queue_size=1000, 
            slop= 1,  # 허용 시간 차이 (초)
            allow_headerless=True  # 헤더가 없어도 동기화 시도
        )
        ...
        # 저장할 폴더 설정
        self.SCEN_NAME = 'Synchronize_renewal'
        ...
        self.camera_paths = {
            ...
            6: f'{self.base_path}/cam6',
            8: f'{self.base_path}/cam8'
        }
